...
void VSoc::_ctor_var_reset() {
    ...
    Soc__DOT__CPU__DOT__E_branchRedirect = VL_RAND_RESET_I(1);
    Soc__DOT__CPU__DOT__E_jalrRedirect = VL_RAND_RESET_I(1);
    ...
    Soc__DOT__CPU__DOT__DE_isMUL = VL_RAND_RESET_I(1);
    ...
    Soc__DOT__CPU__DOT____Vcellinp__MULU__start = VL_RAND_RESET_I(1);
    ...
    Soc__DOT__CPU__DOT__MULU__DOT__busy_r = VL_RAND_RESET_I(1);
    Soc__DOT__CPU__DOT__MULU__DOT__stage1_valid_r = VL_RAND_RESET_I(1);
    Soc__DOT__CPU__DOT__MULU__DOT__finished_r = VL_RAND_RESET_I(1);
    Soc__DOT__CPU__DOT__MULU__DOT__funct3_r = VL_RAND_RESET_I(3);
    Soc__DOT__CPU__DOT__MULU__DOT__rs1_r = VL_RAND_RESET_I(32);
    Soc__DOT__CPU__DOT__MULU__DOT__rs2_r = VL_RAND_RESET_I(32);
    Soc__DOT__CPU__DOT__MULU__DOT__product_r = VL_RAND_RESET_Q(64);
    Soc__DOT__CPU__DOT__MULU__DOT__result_r = VL_RAND_RESET_I(32);
    Soc__DOT__CPU__DOT__MULU__DOT__multiply = VL_RAND_RESET_Q(64);
    Soc__DOT__CPU__DOT__MULU__DOT__mul_result = VL_RAND_RESET_I(32);
    ...
    Soc__DOT__PROGROM__DOT__dout_r = VL_RAND_RESET_I(32);
    { int __Vi0=0; for (; __Vi0<16384; ++__Vi0) {
            Soc__DOT__DATARAM__DOT__mem[__Vi0] = VL_RAND_RESET_I(32);
    }}
    Soc__DOT__DATARAM__DOT__rdata_r = VL_RAND_RESET_I(32);
    ...
    __Vfunc_Soc__DOT__CPU__DOT__BP__DOT__history_hash__7__history = VL_RAND_RESET_I(9);
