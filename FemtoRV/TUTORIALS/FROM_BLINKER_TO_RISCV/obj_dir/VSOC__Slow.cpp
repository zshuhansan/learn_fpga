...
void VSOC::_initial__TOP__3(VSOC__Syms* __restrict vlSymsp) {
    ...
    __Vtemp17[1U] = 0x4152414dU;
    __Vtemp17[2U] = 0x444154U;
    VL_READMEM_N(true, 32, 16384, 0, VL_CVT_PACK_STR_NW(3, __Vtemp17)
                 , vlTOPp->SOC__DOT__CPU__DOT__DATARAM
                 , 0, ~0ULL);
    __Vtemp18[0U] = 0x2e686578U;
    __Vtemp18[1U] = 0x47524f4dU;
    __Vtemp18[2U] = 0x50524fU;
    VL_READMEM_N(true, 32, 16384, 0, VL_CVT_PACK_STR_NW(3, __Vtemp18)
...
void VSOC::_ctor_var_reset() {
    ...
    SOC__DOT__CPU__DOT__branch_history = VL_RAND_RESET_I(9);
    ...
    SOC__DOT__CPU__DOT__RAS_0 = VL_RAND_RESET_I(32);
    SOC__DOT__CPU__DOT__RAS_1 = VL_RAND_RESET_I(32);
    SOC__DOT__CPU__DOT__RAS_2 = VL_RAND_RESET_I(32);
    SOC__DOT__CPU__DOT__RAS_3 = VL_RAND_RESET_I(32);
    ...
    SOC__DOT__CPU__DOT__E_multiply = VL_RAND_RESET_Q(64);
    ...
    SOC__DOT__CPU__DOT__EM_Mdata = VL_RAND_RESET_I(32);
    ...
    __Vfunc_SOC__DOT__CPU__DOT__BHT_index__0__Vfuncout = VL_RAND_RESET_I(12);
    __Vfunc_SOC__DOT__CPU__DOT__BHT_index__0__PC = VL_RAND_RESET_I(32);
    __Vfunc_SOC__DOT__CPU__DOT__flip32__2__Vfuncout = VL_RAND_RESET_I(32);
    __Vfunc_SOC__DOT__CPU__DOT__flip32__2__x = VL_RAND_RESET_I(32);
    __Vfunc_SOC__DOT__CPU__DOT__flip32__3__Vfuncout = VL_RAND_RESET_I(32);
    __Vfunc_SOC__DOT__CPU__DOT__flip32__3__x = VL_RAND_RESET_I(32);
}
